    ...
    <footer className={styles.footer}>
      <div className={styles.inner}>
        ...
        <div className={styles.brand}>
          ...
          <a href="https://dsc.gg/flyanime" target="_blank" rel="noopener noreferrer" className={styles.discordBtn}>
      ...
      <div className={styles.bottom}>
        <p className={styles.copy}>© {new Date().getFullYear()} Fly Anime. All rights reserved.</p>
        <div className={styles.bottomLinks}>
          <Link href="/privacy" className={styles.bottomLink}>Privacy</Link>
          <Link href="/terms"   className={styles.bottomLink}>Terms</Link>
          <Link href="/dmca"    className={styles.bottomLink}>DMCA</Link>
        </div>
      </div>
    </footer>
  );
